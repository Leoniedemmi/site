    ...
    <main>
        <section class="product-detail">
            <div class="product-container">
                <img src="../img/ski_freestyle/ARV_84_253,90.png" alt="Ski de Piste X1" class="product-image">
                <div class="product-info">
                    <h2>ARV - 84</h2>
                    <p>Prix : 253,90€</p>
                    <p>
                        Les skis freestyle "84" sont conçu pour les skieurs exigeants, offrant une excellente stabilité, 

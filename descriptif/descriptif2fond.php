    ...
    <main>
        <section class="product-detail">
            <div class="product-container">
                <img src="../img/ski_de_fond/FISCHER_AEROLITE90_399,00.png" alt="Ski de Piste X1" class="product-image">
                <div class="product-info">
                    <h2>FISCHER - AEROLITE</h2>
                    <p>Prix : 399,00€</p>
                    <p>
                        Les skis de fond "AEROLITE" sont conçu pour les skieurs exigeants, offrant une excellente stabilité, 

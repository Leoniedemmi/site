    ...
    <main>
        <section class="product-detail">
            <div class="product-container">
                <img src="../img/snowboard/NIDECKER_ESCAPE_471,30.png" alt="Ski de Piste X1" class="product-image">
                <div class="product-info">
                    <h2>NIDECKER - ESCAPE</h2>
                    <p>Prix : 471,30€</p>
                    <p>
                        Le snowboard "ESCAPE" est conçu pour les skieurs exigeants, offrant une excellente stabilité, 

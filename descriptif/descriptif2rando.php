    ...
    <main>
        <section class="product-detail">
            <div class="product-container">
                <img src="../img/ski_de_rando/ATOMIC_BACKLAND_391,90.png" alt="Ski de Piste X1" class="product-image">
                <div class="product-info">
                    <h2>ATOMIC - BACKLAND</h2>
                    <p>Prix : 391,90€</p>
                    <p>
                        Les skis de randonnée "BACKLAND" sont conçu pour les skieurs exigeants, offrant une excellente stabilité, 
                    ...
                    <form action="../quantite.php" method="GET">
                        ...
                        <input type="hidden" name="product_name" value="Ski de fond Atomic Backland">
